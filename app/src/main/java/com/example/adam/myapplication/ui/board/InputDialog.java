...
public class InputDialog {
    ...
    public AlertDialog inputTemperatureDialog(final BoardFragment mainFragment, final int position) {
...
//                    mainFragment.setTemperatureResult(position, input_value);
    ...
    public AlertDialog inputPressureDialog(final BoardFragment mainFragment, final int position){
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle("Wprowadź wartość");
