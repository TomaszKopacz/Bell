...
public class MeasurementTaskFragment extends Fragment {

    private CheckBox box;
    private ExpandableLayout expandableDateLayout;


    public MeasurementTaskFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_measurement_task, container, false);
